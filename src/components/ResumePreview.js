      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Rakesh Ranjan"}
              </Heading>
              <Text color={"gray.500"}>
                {about.role ? about.role : "Web Developer"}
              </Text>
            </VStack>
          </HStack>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "rakeshranjantjit@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+919606631812"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Noida, Delhi"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                ...
                {educationList.map((education) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"}>
                        {school ? school : "T.John Institute of Technology, Bangalore"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
              ...
              <VStack alignItems={"flex-start"}>
                ...
                {workList.map((work) => {
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={"medium"}>
                        {position ? position : "Web Developer"}
                      </Text>
                      <Text fontSize={"sm"}>
                      ...
                      <Text fontSize={"xs"} fontStyle={"italic"}>
                        {startDate ? startDate : "2024-03"} -{" "}
                        {endDate ? endDate : "2025-12"}
                      </Text>
